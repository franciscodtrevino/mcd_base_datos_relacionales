...
5. Uso de TIMESTAMP vs. DATETIME: sirve para incrementar la precisión y la zona horaria.

Nota: Los hallazgos mencionados se resolverán con mejoras al script de la tarea # 7.
